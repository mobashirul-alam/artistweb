            ...
            <div className="space-y-40">
                <div className="space-y-6">
                    ...
                    <p className="text-[28px] max-w-2xl">
                        ...
                        business challenges and define their digital strategies
                        and objectives that deliver results. We help bring ideas
                        to life and create brands, websites & digital products
                        that work.
                    </p>
                </div>
                ...
                <div className="bg-[#ECF1F4] rounded-3xl p-16">
                    <div className="grid md:grid-cols-2 divide-x divide-[#72777e59]">
                        <div className="text-center p-10">
                            <p className="text-[68px] font-semibold mb-2">20</p>
